...
const CleaningFormPage = () => {
  ...
  return (
    <PageLayout>
      <Head title="Add Cleaning & Sanitation Entry" />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 64px)' }}>
        <div style={{ flexShrink: 0 }}>
          ...
          <div className="panel-header-row">
            <div>
              <h1 className="page-title">Add Cleaning & Sanitation Entry</h1>
              <p className="page-subtitle" style={{ color: 'var(--color-text-secondary)', marginTop: '4px' }}>
                Record completed cleaning tasks against your active cleaning areas and checklists.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', paddingBottom: '24px', marginRight: '-12px', paddingRight: '12px' }}>
          <Card padding="0">
            <CleaningForm onSave={handleSave} onCancel={handleCancel} />
          </Card>
        </div>
      </div>
    </PageLayout>
